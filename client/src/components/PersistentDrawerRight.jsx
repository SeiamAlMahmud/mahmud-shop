    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <Divider />
                {/* <List>
          {['Revi', 'Starred', 'Send email', 'Drafts'].map((text, index) => (
            <ListItem key={text} disablePadding>
              <ListItemButton>
                ...
                <List>
                    <ListItemButton>
                        <Link to={'/bag'} className='w-full inline-block'> <i className='bx text-xl bxs-backpack'></i>  BackPack</Link>
                    </ListItemButton>
                    <ListItemButton>
                        <Link to={'/mysneaker'} className='w-full inline-block'><i className='text-xl bx bxs-package'></i> Sneakers</Link>
                    </ListItemButton>
                </List>
            </Drawer>
        </Box>
